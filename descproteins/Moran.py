...
if __name__ == '__main__':
    ...
    parser.add_argument("--props", help="input the property names, the names were separated by the symbol ':'")
    parser.add_argument("--nlag", help="set the nlag value, default is 30")
